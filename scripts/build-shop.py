...
.cart-confirm{margin-bottom:16px;padding:18px;background:rgba(76,82,35,.12);border:1px solid rgba(76,82,35,.45);border-radius:4px}
.cart-confirm-msg{font-size:12px;color:var(--off-white);font-weight:600;letter-spacing:1.5px;text-transform:uppercase;margin-bottom:14px;text-align:center}
.cart-confirm-actions{display:flex;flex-direction:column;gap:10px}
.cart-confirm-checkout{display:block;text-align:center;padding:14px;background:var(--olive);color:var(--white);font-size:12px;font-weight:600;letter-spacing:2px;text-transform:uppercase;transition:background .3s}
.cart-confirm-checkout:hover{background:var(--olive-light)}
.cart-confirm-keep{display:block;text-align:center;padding:14px;border:1px solid var(--olive);color:var(--off-white);font-size:12px;font-weight:600;letter-spacing:2px;text-transform:uppercase;transition:background .3s}
.cart-confirm-keep:hover{background:rgba(76,82,35,.2)}
    ...
    (function() {{
      ...
      addBtn.addEventListener('click', () => {{
        ...
        if (window.Cart) {{
          ...
          var cc=document.getElementById('cartConfirm');if(cc)cc.hidden=false;
